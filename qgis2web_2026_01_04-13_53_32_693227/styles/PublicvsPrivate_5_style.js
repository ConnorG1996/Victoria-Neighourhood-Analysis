var size = 0;
var placement = 'point';
function categories_PublicvsPrivate_5(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Independent School':
...
var style_PublicvsPrivate_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("SCHOOL_CATEGORY");
    ...
    var style = categories_PublicvsPrivate_5(feature, value, size, resolution, labelText,
